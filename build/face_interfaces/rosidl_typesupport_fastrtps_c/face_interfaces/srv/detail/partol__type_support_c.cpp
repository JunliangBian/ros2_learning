...
#include "face_interfaces/srv/detail/partol__rosidl_typesupport_fastrtps_c.h"
...
using _Partol_Request__ros_msg_type = face_interfaces__srv__Partol_Request;
...
static uint32_t _Partol_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_face_interfaces__srv__Partol_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = face_interfaces__srv__Partol_Request;
    is_plain =
      (
...
static size_t _Partol_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_face_interfaces__srv__Partol_Request(
...
using _Partol_Response__ros_msg_type = face_interfaces__srv__Partol_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_face_interfaces__srv__Partol_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = face_interfaces__srv__Partol_Response;
    is_plain =
      (
...
static size_t _Partol_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_face_interfaces__srv__Partol_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "face_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "face_interfaces/srv/partol.h"
