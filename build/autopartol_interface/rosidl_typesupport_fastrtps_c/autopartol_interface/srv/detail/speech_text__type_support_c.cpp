...
#include "autopartol_interface/srv/detail/speech_text__rosidl_typesupport_fastrtps_c.h"
...
#include "autopartol_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SpeechText_Request__ros_msg_type = autopartol_interface__srv__SpeechText_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopartol_interface
size_t get_serialized_size_autopartol_interface__srv__SpeechText_Request(
  const void * untyped_ros_message,
...
static uint32_t _SpeechText_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autopartol_interface__srv__SpeechText_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopartol_interface
size_t max_serialized_size_autopartol_interface__srv__SpeechText_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autopartol_interface__srv__SpeechText_Request;
    is_plain =
      (
...
static size_t _SpeechText_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autopartol_interface__srv__SpeechText_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopartol_interface, srv, SpeechText_Request)() {
...
using _SpeechText_Response__ros_msg_type = autopartol_interface__srv__SpeechText_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopartol_interface
size_t get_serialized_size_autopartol_interface__srv__SpeechText_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpeechText_Response__ros_msg_type * ros_message = static_cast<const _SpeechText_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autopartol_interface__srv__SpeechText_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopartol_interface
size_t max_serialized_size_autopartol_interface__srv__SpeechText_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autopartol_interface__srv__SpeechText_Response;
    is_plain =
      (
...
static size_t _SpeechText_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autopartol_interface__srv__SpeechText_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopartol_interface, srv, SpeechText_Response)() {
...
// already included above
// #include "autopartol_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "autopartol_interface/srv/speech_text.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopartol_interface, srv, SpeechText)() {
