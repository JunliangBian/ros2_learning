...
class Metaclass_SpeechText_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autopartol_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SpeechText(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autopartol_interface.srv.SpeechText')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autopartol_interface.srv import _speech_text
...
class SpeechText(metaclass=Metaclass_SpeechText):
    from autopartol_interface.srv._speech_text import SpeechText_Request as Request
    from autopartol_interface.srv._speech_text import SpeechText_Response as Response
